package com.androidmonk.sunshine.utilities;
...
public final class NetworkUtils {
    ...
    public static URL getUrl(Context context){
        if (SunshinePreferences.isLocationLatLonAvailable(context)){
            double[] preferenceCoordinates = SunshinePreferences.getLocationCoordinates(context);
            double latitude = preferenceCoordinates[0];
            double longitude = preferenceCoordinates[1];
